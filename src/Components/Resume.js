        ...
        <Grid className="resume-gird">
          <Cell col={4}>
            ...
            <p style={{ textAlign: "justify" }}>
              Hello, I'm Sonam Kumari, a versatile tech enthusiast and
              full-stack MERN developer with a passion for cutting-edge
              technologies. My expertise extends across the realms of machine
              learning, AWS cloud computing, and C++ programming. With a keen
              interest in exploring the frontiers of technology, I bring a
              dynamic skill set to the table. My journey as a developer is
              characterized by a commitment to staying at the forefront of
              innovation, ensuring that I deliver solutions that align with the
              ever-evolving landscape of the tech industry.
            </p>
            <hr style={{ borderTop: "2px solid #833fb2", width: "50%" }} />
            <h5>Address</h5>
            Noida, Uttar Pradesh
          ...
          <Cell className="resume-right-col" col={8} style={{ backgroundColor:'#F5F5F5', color:'black'}} >
            <h2>Experience</h2>
            <Experience
            ...
            <Education
              ...
              degreeName={
                "B.Tech in Computer Science & Engineering with specialization in Datascience"
              }
            />
            <Education
              startYear={2018}
